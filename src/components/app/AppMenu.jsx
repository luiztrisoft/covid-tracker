...
export class AppMenu extends Component {
    ...
    createMenu() {
        this.menu = [
            {label: 'Dashboard', icon: 'fas fa-home', command: () => {window.location = '#/'}},  
            {label: 'Situação por estados', badge: '27', icon: 'fas fa-globe-americas', command: () => {window.location = '#/estados'}},          
            // {
            //     label: 'Brasil', icon: 'pi pi-globe',
            //     items: [
            //         {label: 'Situação dos estados', badge: '27', icon: 'pi pi-th-large', to: '/estados'}					
            //     ]
            // },            
            {label: 'Informações', icon: 'fas fa-info', to: '/info'}
        ];
    }
